...
Key Visuals
• Overall Dashboard: Displays total bookings, total booking value, booking status breakdown, and ride trends over time.
• Vehicle Type Analysis: Compares booking value, successful bookings, average distance travelled, and total distance across different vehicle categories.
• Revenue Analysis: Shows revenue generated through different payment methods and daily ride-distance distribution.
• Cancellation Analysis: Breaks down customer and driver cancellations by different cancellation reasons.
• Ratings Analysis: Compares customer and driver ratings across multiple vehicle types.
• Date Filters & Navigation: Allows users to interactively filter data and move between dashboard sections.
